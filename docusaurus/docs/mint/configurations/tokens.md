...
Mint can currently be configured in different ways: either through [JSON configuration](mint-customization) from the Sinequa administration interface, or by using parameters (injection tokens) within the application code.
