...
It is mainly handled inside `PreviewTabsComponent` which relies on the feature flag and and `previewData.conversions` data fetched after the initial preview loading.
