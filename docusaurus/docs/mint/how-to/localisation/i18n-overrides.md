...
**1.** Open [src/config/transloco-loader-overrides.ts](../../../config/transloco-loader-overrides.ts) and add the scope name to the list:
...
| File | Role |
|------|------|
| [transloco-loader-overrides.ts](../../../config/transloco-loader-overrides.ts) | Custom loader — fetches base + override, merges them |
| [transcolo-providers.ts](../../../config/transcolo-providers.ts) | Registers the loader in the Angular app |
| [deepmerge.ts](../../../utils/deepmerge.ts) | Deep-merges the two JSON objects (nested keys work too) |
