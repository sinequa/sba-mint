...
```sh
# Add Angular and Sinequa dependencies
npm install @angular/cdk @jsverse/transloco @sinequa/atomic @sinequa/atomic-angular @sinequa/ui ngx-sonner tailwind-merge
```
