...
```ts
<<<<<<<< HEAD:docusaurus/versioned_docs/version-11.14.0/atomic-angular/stores/app.mdx
...
| parameter  | type   | description |
|------------|--------|-------------|
| `route`  | `ActivatedRoute` | The activated route containing the query name in its data. |
...
>>>>>>>> origin/release/11.14.0:docusaurus/versioned_docs/version-11.13.0/atomic-angular/stores/app.mdx
