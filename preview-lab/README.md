...
Fixtures are generated by `fixtures/_fixture.js` so the geometry is deterministic
and the expected block count is **derived** from the placement data rather than
restated by hand.
