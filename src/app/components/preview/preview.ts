...
import { ButtonComponent, XMarkIcon } from "@sinequa/ui";
...
@Component({
  ...
  imports: [PreviewNavbarComponent, PreviewTabsComponent, PreviewHeaderComponent, AdvancedSearch, ButtonComponent, XMarkIcon, TranslocoPipe],
