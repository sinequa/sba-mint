...
import { APP_INITIALIZER, ApplicationConfig, inject, isDevMode, LOCALE_ID, provideAppInitializer, provideZonelessChangeDetection } from "@angular/core";
...
import { provideDefaultRendererPlugins, provideDefaultShikiHighlighterConfig } from "@sinequa/agent";
import {
