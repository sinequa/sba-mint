...
import { cn, SidebarMenuButtonComponent, SidebarMenuComponent, SidebarMenuItemComponent, TooltipDirective, useSidebar } from "@sinequa/ui";

@Component({
  selector: "app-sidebar-group-assistant",
  template: `
    <sidebar-menu>
      <sidebar-menu-item [class]="cn('invisible', allowAI() && 'visible')" aria-label="Chats">
        <sidebar-menu-button
          class="text-lg"
