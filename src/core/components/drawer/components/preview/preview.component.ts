...
import { Component, Inject, InjectionToken, OnInit, Type, computed, inject, input } from '@angular/core';
...
import { ExtractsLocationService, PreviewService } from '@sinequa/atomic-angular';
